    ...
    <div className="flex text-white relative mb-14 lg:mb-4 mt-14 md:mt-24 2xl:mt-6 lg:mt-auto md:px-16 lg:px-0">
      <div className="w-full flex flex-col lg:flex-row mb-4 lg:justify-between ">
        <div className="z-10 flex flex-col md:w-[34rem] lg:w-[32rem] xl:w-[40rem]">
          <h1 className="leading-normal text-[2.5rem] xl:text-[3.8rem] font-extrabold mb-5">
        ...
        <div
          ...
          className="absolute w-[14.5rem] h-[12.5rem] right-[-2rem] top-[6.2rem] md:right-[9.8rem] md:top-[5.5rem] lg:right-[23rem] lg:top-[5.5rem] xl:right-[22rem] xl:top-[7.5rem] 2xl:right-[35rem] 2xl:top-[8.5rem] duration-300"
        >
        ...
        <div
          ...
          className="hidden sm:inline absolute w-[12.8rem] h-[12.8rem] left-[-4rem] top-[21rem] md:left-auto md:right-[27rem] md:top-[22rem] lg:right-[5rem] lg:top-[13.5rem] xl:right-[5.5rem] xl:top-[17rem] 2xl:right-[14rem] 2xl:top-[18.5rem] duration-300"
        >
          <Image src="/assets/governance/circle-2.svg" alt="circle 2" layout="fill" priority />
        </div>
        <div
          style={{ transform: `translate(${offsetY * 0.006}px, ${offsetY * 0.006}px)` }}
          className="absolute w-[12.8rem] h-[12.8rem] right-[-10rem] top-[22.2rem] md:right-[2rem] lg:right-[-7.5rem] lg:top-[22.5rem] xl:right-[-8rem] xl:top-[23rem] 2xl:right-[0.5rem] 2xl:top-[24rem] duration-300"
        >
        ...
        <div
          ...
          className="absolute w-[3rem] h-[3rem] right-[22rem] top-[130rem] lg:right-[22rem] lg:top-[19.5rem] xl:right-[22rem] xl:top-[23rem] 2xl:right-[33.5rem] 2xl:top-[26rem] duration-300"
        >
