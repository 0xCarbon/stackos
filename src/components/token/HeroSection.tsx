        ...
        <div className="lg:flex lg:flex-col mb-14">
          <div className="flex flex-row justify-start items-center mb-9 lg:mb-12">
            <h1 className="text-white font-extrabold text-4xl lg:text-6xl">
              Token
              <p className="text-main-green">holders</p>
            </h1>
          </div>
          <p className="text-white font-normal text-xl max-w-lg">
            Trade, utilize or govern - there are so many ways to put your STACK tokens to good use.
          </p>
        </div>
