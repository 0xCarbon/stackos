...
const Card = ({ src, title, subtitle }: Props) => (
  <div className="group shadow-[0_0_47px_rgba(255,255,255,0.12)] rounded-xl bg-main-blue w-[289px] h-[429px] hover:translate-y-[-0.6rem] hover:shadow-[0_0_47px_#ffffff2d] duration-500">
